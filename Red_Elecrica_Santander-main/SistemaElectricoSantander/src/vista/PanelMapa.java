...
public class PanelMapa extends JPanel {
    ...
    private boolean mostrarNombresGeneradores = false;
...
Point2D p2 = map.convertGeoPositionToPoint(new GeoPosition(lat2, lon2));
    ...
    JCheckBox chkNombres = new JCheckBox("Mostrar nombres generadores");
    chkNombres.setBackground(new Color(245, 245, 245));
    chkNombres.addActionListener(e -> {
    mostrarNombresGeneradores = chkNombres.isSelected();
    refrescarPintores();
    });
        leyenda.add(chkNombres);
