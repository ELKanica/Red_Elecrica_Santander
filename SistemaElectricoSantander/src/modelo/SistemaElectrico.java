...
public class SistemaElectrico {
    ...
    public List<Generador> getGeneradores() { return generadores; }

    public void setSubestaciones(List<Subestacion> subestaciones) {
        this.subestaciones = subestaciones;
    }
    public void setGeneradores(List<Generador> g) { this.generadores = g; }
    ...
    public Generador buscarGeneradorPorNombre(String nombre) {
